...
function Sidebar(){
    ...
    return(
        <div className={`${isSidebarOpen ? "w-56" : "w-20 "} fixed flex flex-col top-16 left-0 transition-all border-none z-10 sidebar bg-purple-color h-screen p-5 duration-300`}>
